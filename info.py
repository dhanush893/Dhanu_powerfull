...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002308128053').split()]  # Channel id for auto indexing (make sure bot is admin)
